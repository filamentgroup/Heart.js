...
(function($) {
	var pluginName = "threesixty",
		...
		methods = {
			_create: function(){
				var inst = ['<div class="dialog-360">',
							'<p>360 View</p>',
							'<img src="_img/360-arrows.png">',
							'<p class="inst">Swipe or Drag</p>',
							'</div>'].join("");
...
(function($) {
	...
	$( initSelector ).live( "dragstart dragmove drag", function( e ) {
		...
		$el.next( ".dialog-360" ).addClass( "fadeout" );
		$el.find( ".introslide" ).removeClass( "introslide" );
	});
